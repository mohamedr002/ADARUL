...
def cross_domain_train(da_params,src_id,tgt_id,run_id):
    ...
    src_only_loss, src_only_score, tgt_features, _, pred_labels,true_labels = evaluate(source_model, tgt_test_dl, criterion, config)
    test_loss, test_score, tgt_trained_features, _, pred_labels_DA,true_labels_DA = evaluate(target_model, tgt_test_dl, criterion, config)
